...
<body>
    ...
    <section class="bg">
        <div class="tittle container text-center">
            <h1 class="display-7 font-family-sans-serif fw-bold">Haul</h1>
            <h2 class="display-5 font-family-sans-serif fw-bold">Almagfurlah</h2>
        </div>
    </section>
    <!-- foto kegiatan akhir -->
    ...
    <div class="container-fluid mt-4 pb-3 fade-up">
        <div class="container ">
            ...
            <p style="text-align: justify;">Haul Almagfurlah merujuk pada peringatan atau perayaan yang diadakan untuk mengenang dan merayakan
                ...
                agama Islam.
                Istilah "Almagfurlah" sendiri berasal dari bahasa Arab yang berarti "yang diampuni" atau "yang mendapat
                ampunan."</p>
            ...
            <p style="text-align: justify;">Acara ini biasanya mencakup majelis ilmu, di mana para ulama atau tokoh agama memberikan ceramah,
                ...
                tentang ajaran
                Islam, kisah hidup tokoh yang dihormati, dan nilai-nilai keagamaan.
            </p>
            ...
            <p style="text-align: justify;">Haul Almagfurlah biasanya melibatkan partisipasi massal dari umat Islam, termasuk para santri, masyarakat
                ...
                komunitas Muslim,
                dan dalam beberapa tradisi tertentu, peringatan ini mungkin dianggap sebagai bentuk ibadah yang
                bermanfaat.
            </p>
        </div>
    </div>
