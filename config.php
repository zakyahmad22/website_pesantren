<?php
$servername = "localhost"; // Nama server database, dalam hal ini adalah localhost, yang berarti servernya berada di komputer yang sama dengan kode ini dijalankan.
$username = "root"; // Username untuk mengakses database, yaitu root (akun default untuk MySQL).
$password = ""; // Password untuk username tersebut Kosong (""), karena akun root di komputer lokal biasanya tidak memiliki password secara default.
