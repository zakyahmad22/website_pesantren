...
<body>
    ...
    <!-- panca jiwa awal -->
    <div class="container-fluid mt-5 pt-5 pb-3 fade-up">
        <div class="container">
            <div class="clearfix pt-4">
                <h1 class="font-family-sans-serif fw-bold fs-2 text-center">INFORMASI TES UJIAN</h1>
                <h2 class="font-family-sans-serif fw-bold fs-2 text-center">Calon Santri Baru</h2>
                <h3 class="font-family-sans-serif fs-4 text-center">Tahun 2024/2025</h3>
                <p class="font-family-sans-serif pt-3">
                    Bagi calon santriwan/santriwati yang sudah lulus Ujian Masuk KMI dan memenuhi syarat-syarat
                    tertentu, diberi
                    kesempatan untuk
                    mengikuti Ujian Lanjutan (Ujian Masuk ke Kelas 2, 3, 3 Intensif, 4, 5, dan 6).
                </p>
                <h3 class="font-family-sans-serif fw-bold fs-5">A. PERSYARATAN DAN MATERI UJIAN SMP AL-MUFLIHIN:</h3>
                <h1 class="font-family-sans-serif fs-5 ms-3">1. Ujian SMP Al-Muflihin</h1>
                <p class="ps-5">a. Materi Ujian Lisan:</p>
                <p class="ms-5">- Muhadatsah <br> - Muthala’ah <br> - Mahfudzat <br> - Mufradat dan Terjemah</p>
                <h2 class="font-family-sans-serif fs-5 ms-3">2. Ujian SMP Al-Muflihin</h2>
                <p class="ps-5">a. Materi Ujian Tulis:</p>
                <p class="ms-5">- Insya’ dan Tamrin Lughah <br> - Bahasa Inggris
                    <br> - Aqa’id dan Fiqh
                </p>
                <h3 class="font-family-sans-serif fw-bold fs-5">B. PERSYARATAN DAN MATERI UJIAN MA AL-MUFLIHIN:</h3>
                <h1 class="font-family-sans-serif fs-5 ms-3">1. Ujian MA Al-Muflihin</h1>
                <p class="ps-5">a. Materi Ujian Lisan:</p>
                <p class="ms-5">- Muhadatsah <br> - Muthala’ah <br> - Mahfudzat <br> - Mufradat dan Terjemah</p>
                <h2 class="font-family-sans-serif fs-5 ms-3">2. Ujian MA Al-Muflihin</h2>
                <p class="ps-5">a. Materi Ujian Tulis:</p>
                <p class="ms-5">- Insya’ dan Tamrin Lughah <br> - Bahasa Inggris
                    <br> - Aqa’id dan Fiqh
                </p>
